<template>
  <div v-show="!isLoading" id="setTimeModal" style="display: flex; align-items: center" class="py-1 px-2 rounded-md">
    <input id="minute" type="text" class="text-center pointer-events-none" :value="formatTime(timerService.minutes)" />
    <span style="padding: 0 5px">:</span>
    <input id="second" type="text" class="text-center pointer-events-none" :value="formatTime(timerService.seconds)" />
      ...
      <template #content>
        <div class="text-sm font-medium shadow-md">
          <div class="flex items-center mb-1">
            <svg t="1755921599827" class="mr-1" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
              p-id="6035" width="16" height="16">
              <path
          ...
          <div class="flex items-center">
            <svg t="1755921722533" class="mr-1" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
              p-id="7370" width="16" height="16">
              <path
...
export default {
  ...
  setup(props) {
    ...
    const resetTimer = ({ minutes = 25, seconds = 0 }) => {
      console.log(minutes);

      clearInterval(timerService.timer);
      timerService.minutes = getMinutes(minutes);
